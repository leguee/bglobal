...
namespace testApplication.Controllers
{
    ...
    public class VehicleController : Controller
    {
        ...
        {
            List<Employee> employees = await new ApiEmployees().GetEmployees();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Patente,Marca,Modelo,Puertas,Titular")] Vehicle vehicle)
        {
            if (id != vehicle.Id)
            {
                return NotFound();
